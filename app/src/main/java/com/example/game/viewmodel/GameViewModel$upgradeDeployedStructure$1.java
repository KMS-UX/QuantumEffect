...
@DebugMetadata(c = "com.example.game.viewmodel.GameViewModel$upgradeDeployedStructure$1", f = "GameViewModel.kt", i = {1, 1, 1}, l = {535, 549}, m = "invokeSuspend", n = {"current", "updatedStructures", "updated"}, s = {"L$0", "L$1", "L$2"})
/* loaded from: classes4.dex */
public final class GameViewModel$upgradeDeployedStructure$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public GameViewModel$upgradeDeployedStructure$1(GameViewModel gameViewModel, int i, int i2, long j, Continuation<? super GameViewModel$upgradeDeployedStructure$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new GameViewModel$upgradeDeployedStructure$1(this.this$0, this.$creditsCost, this.$nanitesCost, this.$structureId, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((GameViewModel$upgradeDeployedStructure$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
            ...
            case 0:
                ...
                for (DeployedStructure deployedStructure : deployedStructures) {
                    if (deployedStructure.getId() == j) {
                        deployedStructure = DeployedStructure.copy$default(deployedStructure, 0L, null, null, null, null, 0.0f, 0.0f, 0L, true, deployedStructure.getLevel() + 1, 255, null);
                    }
